...
const PROJECTS = [
  {
    ...
    domain: "floww.build",
    desc: "Production B2B social media automation SaaS. Built Instagram & Facebook automation on the Meta Graph API — keyword triggers, DM flows, comment-reply automation and story-mention responses, with webhook deduplication via canonical ID matching and a React Flow visual builder.",
    tag: "Next.js · NestJS · TypeScript · PostgreSQL · Meta Graph API",
  },
  {
    name: "Click2Deploy",
    url: "https://click2deploy.com",
    domain: "click2deploy.com",
    desc: "Multi-tenant cloud deployment SaaS with Stripe billing, subscription management and plan-based access control. Implemented billing webhooks and fixed a critical production bug where subscription upgrades weren't reflected in the database.",
    tag: "Next.js · NestJS · TypeScript · PostgreSQL · Stripe",
  },
  {
    name: "Toolrift",
